    ...
    () => [
      ...
      },
      {
        ...
        cell: ({ row }) => (
          <span className="tabular-nums text-muted-foreground">
            {row.getValue<number>("total_accounts")}
          </span>
        ),
      },
      {
        ...
        cell: ({ row }) => (
          <Badge
            variant="outline"
            className="tabular-nums text-green-600 border-green-200 dark:border-green-900"
          >
      ...
      },
      {
        ...
        cell: ({ row }) => {
          ...
          return n > 0 ? (
            <Badge variant="outline" className="tabular-nums text-orange-600 border-orange-200">
              {n}
            </Badge>
          ) : (
            <span className="text-muted-foreground/40 tabular-nums">0</span>
